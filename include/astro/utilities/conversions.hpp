...
namespace conversions {
    ...
    element_array coes_to_cartesian(element_array coes, GravitationalBody centralBody);
    element_array cartesian_to_coes(element_array cartesian, GravitationalBody centralBody);
    ...
    using set_conversion_function = std::function<element_array(element_array, GravitationalBody)>;
    ...
    element_array convert(element_array elements, ElementSet fromSet, ElementSet toSet, GravitationalBody centralBody);
}
