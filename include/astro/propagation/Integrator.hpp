...
private:
	...
	// Equations of motion
    std::vector<double> find_state_derivative(const Time& time, const OrbitalElements& state, const EquationsOfMotion& eom, Vehicle& vehicle);
	...
	// Error Methods
	void check_error(const double& maxError, const std::vector<double>& stateNew, const std::vector<double> stateError,
