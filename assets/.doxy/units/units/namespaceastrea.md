...
```C++
using astrea::AngularVelocity = typedef mp_units::quantity<detail::angle_unit / detail::time_unit>;
```
...
_Definition for a force quantity._ 
```C++
using astrea::Force = typedef mp_units::quantity<detail::force_unit>;
```
...
```C++
using astrea::Frequency = typedef mp_units::quantity<mp_units::one / detail::time_unit>;
```
...
```C++
using astrea::Length = typedef mp_units::quantity<detail::distance_unit>;
```
...
```C++
using astrea::Moment = typedef mp_units::quantity<detail::force_unit * detail::distance_unit>;
```
