...
|  std::vector&lt; double &gt; | [**force\_to\_double\_vector**](#function-force_to_double_vector) () const<br>_Convert the STM to a vector of unitless quantities._  |
...
```C++
std::vector< double > astrea::astro::StateTransitionMatrix::force_to_double_vector () const
```
