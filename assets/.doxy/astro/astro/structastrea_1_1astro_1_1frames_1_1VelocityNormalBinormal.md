...
[**ClassList**](annotated.md) **>** [**astrea**](namespaceastrea.md) **>** [**astro**](namespaceastrea_1_1astro.md) **>** [**frames**](namespaceastrea_1_1astro_1_1frames.md) **>** [**VelocityNormalBinormal**](structastrea_1_1astro_1_1frames_1_1VelocityNormalBinormal.md)
...
```C++
using astrea::astro::frames::VelocityNormalBinormal< _parent_ >::tag_type =  VnbTag<_parent_>;
```
...
_The reference frame of the VNB frame._ 
```C++
constexpr auto astrea::astro::frames::VelocityNormalBinormal< _parent_ >::parent;
```
...
```C++
constexpr tag_type astrea::astro::frames::VelocityNormalBinormal< _parent_ >::tag;
```
...
### function VelocityNormalBinormal [2/2]

_Default constructor is deleted to prevent instantiation without a parent frame._ 
```C++
astrea::astro::frames::VelocityNormalBinormal::VelocityNormalBinormal () = delete
```
...
DirectionCosineMatrix&lt;parent, VelocityNormalBinormal&gt; The DCM from parent to VNB. 
