...
| Type | Name |
| ---: | :--- |
|  Unitless | [**absTol**](#variable-abstol)   = `1.0e-13`<br>_Absolute tolerance for the integrator._  |
|  Time | [**fixedTimeStep**](#variable-fixedtimestep)   = `30.0 \* mp\_units::si::unit\_symbols::s`<br>_Fixed timestep to use if useFixedStep is true._  |
|  Time | [**initialTimeStep**](#variable-initialtimestep)   = `1.0 \* mp\_units::si::unit\_symbols::s`<br>_Initial timestep for the integrator._  |
|  int | [**itMax**](#variable-itmax)   = `10000`<br>_Maximum number of iterations for the integrator._  |
|  Unitless | [**relTol**](#variable-reltol)   = `1.0e-13`<br>_Relative tolerance for the integrator._  |
...
|  bool | [**useFixedStep**](#variable-usefixedstep)   = `false`<br>_Flag to indicate whether to use a fixed timestep._  |
