...
| Type | Name |
| ---: | :--- |
| typedef [**LvlhTag**](structastrea_1_1astro_1_1frames_1_1LvlhTag.md)&lt; \_parent\_ &gt; | [**tag\_type**](#typedef-tag_type)  <br>_Tag type for this frame._  |
...
| Type | Name |
| ---: | :--- |
|  constexpr auto | [**parent**](#variable-parent)   = `\_parent\_`<br>_The reference frame of the LVLH frame._  |
|  constexpr [**tag\_type**](structastrea_1_1astro_1_1frames_1_1LocalHorizontalLocalVertical.md#typedef-tag_type) | [**tag**](#variable-tag)   = `{}`<br>_Empty frame tag satisfying IsFrame._  |
...
| Type | Name |
| ---: | :--- |
|   | [**LocalHorizontalLocalVertical**](#function-localhorizontallocalvertical-12) (const [**RadiusVector**](namespaceastrea_1_1astro.md#typedef-radiusvector)&lt; [**parent**](structastrea_1_1astro_1_1frames_1_1LocalHorizontalLocalVertical.md#variable-parent) &gt; & position, const [**VelocityVector**](namespaceastrea_1_1astro.md#typedef-velocityvector)&lt; [**parent**](structastrea_1_1astro_1_1frames_1_1LocalHorizontalLocalVertical.md#variable-parent) &gt; & velocity) <br>_Constructor for instantaneous dynamic state/frames._  |
...
------------------------------
The documentation for this class was generated from the following file `astrea/astro/astro/frames/definitions/dynamic_frames/LocalHorizontalLocalVertical.hpp`
