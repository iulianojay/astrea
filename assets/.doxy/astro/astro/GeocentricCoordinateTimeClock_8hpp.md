...
[Go to the source code of this file](GeocentricCoordinateTimeClock_8hpp_source.md)

_A clock implementation for Geocentric Coordinate Time (TCG)._ [More...](#detailed-description)
