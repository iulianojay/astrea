...
# Class astrea::astro::TurnThrustersOff



[**ClassList**](annotated.md) **>** [**astrea**](namespaceastrea.md) **>** [**astro**](namespaceastrea_1_1astro.md) **>** [**TurnThrustersOff**](classastrea_1_1astro_1_1TurnThrustersOff.md)



_A class representing a_ [_**TurnThrustersOff**_](classastrea_1_1astro_1_1TurnThrustersOff.md) __[_**Event**_](classastrea_1_1astro_1_1Event.md) _in the astrea astro platform. This class is used as a placeholder for Events that do not have a defined state or mass._

* `#include <TurnThrustersOff.hpp>`
...
| Type | Name |
| ---: | :--- |
|   | [**TurnThrustersOff**](#function-turnthrustersoff) () <br>_Constructs a_ [_**TurnThrustersOff**_](classastrea_1_1astro_1_1TurnThrustersOff.md) __[_**Event**_](classastrea_1_1astro_1_1Event.md) _that triggers at a specific altitude._ |
...
### function TurnThrustersOff 

_Constructs a_ [_**TurnThrustersOff**_](classastrea_1_1astro_1_1TurnThrustersOff.md) __[_**Event**_](classastrea_1_1astro_1_1Event.md) _that triggers at a specific altitude._
```C++
astrea::astro::TurnThrustersOff::TurnThrustersOff () 
```
...
* `triggerAltitude` The altitude at which the [**TurnThrustersOff**](classastrea_1_1astro_1_1TurnThrustersOff.md) should trigger. Default is 0 km, which means it will trigger when the vehicle reaches the default crash radius of the central body. 



**Returns:**

[**TurnThrustersOff**](classastrea_1_1astro_1_1TurnThrustersOff.md) A [**TurnThrustersOff**](classastrea_1_1astro_1_1TurnThrustersOff.md) [**Event**](classastrea_1_1astro_1_1Event.md) that triggers at the specified altitude. 
...
```C++
std::string astrea::astro::TurnThrustersOff::get_name () const
```
...
```C++
bool astrea::astro::TurnThrustersOff::is_terminal () const
```
...
```C++
Unitless astrea::astro::TurnThrustersOff::measure_event (
    const  Time & time,
    const  State & state,
...
```C++
void astrea::astro::TurnThrustersOff::trigger_action (
    const  Time & time,
    State & state,
    Vehicle & vehicle
) const
...
------------------------------
The documentation for this class was generated from the following file `astrea/astro/astro/propagation/event_detection/events/TurnThrustersOff.hpp`
