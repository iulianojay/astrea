...
_Creates a clone of the current J2 Mean VOP object._ 
```C++
inline virtual std::unique_ptr< EquationsOfMotion > astrea::astro::J2MeanVop::clone () override const
```
...
std::unique\_ptr&lt;EquationsOfMotion&gt; A unique pointer to the cloned J2 Mean VOP object. 
...
```C++
virtual OrbitalElementPartials astrea::astro::J2MeanVop::compute_dynamics (
    const State & state,
