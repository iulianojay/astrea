...
| Type | Name |
| ---: | :--- |
|  constexpr auto | [**frame**](#variable-frame)   = `\_frame\_`<br>_The reference frame of the ENU frame._  |
|  constexpr [**tag\_type**](structastrea_1_1astro_1_1frames_1_1EastNorthUp.md#typedef-tag_type) | [**tag**](#variable-tag)   = `{}`<br>_Empty frame tag satisfying IsFrame._  |
...
| Type | Name |
| ---: | :--- |
|   | [**EastNorthUp**](#function-eastnorthup-12) (const [**RadiusVector**](namespaceastrea_1_1astro.md#typedef-radiusvector)&lt; [**frame**](structastrea_1_1astro_1_1frames_1_1EastNorthUp.md#variable-frame) &gt; & position, const [**VelocityVector**](namespaceastrea_1_1astro.md#typedef-velocityvector)&lt; [**frame**](structastrea_1_1astro_1_1frames_1_1EastNorthUp.md#variable-frame) &gt; & velocity) <br>_Constructor for instantaneous dynamic state/frames._  |
