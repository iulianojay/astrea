...
| Type | Name |
| ---: | :--- |
|  std::optional&lt; [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**APOAPSIS**](#variable-apoapsis)  <br>_Apoapsis altitude in kilometers._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**ARG\_OF\_PERICENTER**](#variable-arg_of_pericenter)  <br>_Argument of pericenter in degrees._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**BSTAR**](#variable-bstar)  <br>_B\* drag term (BSTAR) in inverse Earth radii._  |
...
|  std::optional&lt; [**char**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**CLASSIFICATION\_TYPE**](#variable-classification_type)  <br>_Classification type._  |
...
|  [**int**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) | [**DB\_ID**](#variable-db_id)  <br>_Database ID for the GP object._  |
|  std::optional&lt; std::string &gt; | [**DECAY\_DATE**](#variable-decay_date)  <br>_Decay date._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**ECCENTRICITY**](#variable-eccentricity)  <br>_Eccentricity._  |
|  std::optional&lt; [**short**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**ELEMENT\_SET\_NO**](#variable-element_set_no)  <br>_Element set number._  |
|  std::optional&lt; [**short**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**unsigned**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**EPHEMERIS\_TYPE**](#variable-ephemeris_type)  <br>_Ephemeris type._  |
|  std::optional&lt; std::string &gt; | [**EPOCH**](#variable-epoch)  <br>_Epoch._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**unsigned**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**FILE**](#variable-file)  <br>_File number._  |
|  [**unsigned**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) | [**GP\_ID**](#variable-gp_id)  <br>_General Perturbations ID._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**INCLINATION**](#variable-inclination)  <br>_Inclination in degrees._  |
|  std::optional&lt; std::string &gt; | [**LAUNCH\_DATE**](#variable-launch_date)  <br>_Launch date._  |
|  std::optional&lt; [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**MEAN\_ANOMALY**](#variable-mean_anomaly)  <br>_Mean anomaly in degrees._  |
|  std::string | [**MEAN\_ELEMENT\_THEORY**](#variable-mean_element_theory)  <br>_Mean element theory._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**MEAN\_MOTION**](#variable-mean_motion)  <br>_Mean motion in revolutions per day._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**MEAN\_MOTION\_DDOT**](#variable-mean_motion_ddot)  <br>_Mean motion derivative in revolutions per day squared._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**MEAN\_MOTION\_DOT**](#variable-mean_motion_dot)  <br>_Mean motion second derivative in revolutions per day cubed._  |
|  [**unsigned**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) | [**NORAD\_CAT\_ID**](#variable-norad_cat_id)  <br>_NORAD catalog ID._  |
...
|  std::optional&lt; [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**PERIAPSIS**](#variable-periapsis)  <br>_Periapsis altitude in kilometers._  |
|  std::optional&lt; [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**PERIOD**](#variable-period)  <br>_Orbital period in minutes._  |
|  std::optional&lt; [**long**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**RA\_OF\_ASC\_NODE**](#variable-ra_of_asc_node)  <br>_Right ascension of ascending node in degrees._  |
...
|  std::optional&lt; [**unsigned**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**REV\_AT\_EPOCH**](#variable-rev_at_epoch)  <br>_Revolution number at epoch._  |
|  std::optional&lt; [**double**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) &gt; | [**SEMIMAJOR\_AXIS**](#variable-semimajor_axis)  <br>_Semimajor axis in kilometers._  |
...
|   | [**GeneralPerturbations**](#function-generalperturbations-22) ([**const**](classastrea_1_1astro_1_1DirectionCosineMatrix.md) nlohmann::json & data) <br>_Constructor that initializes_ [_**GeneralPerturbations**_](structastrea_1_1astro_1_1GeneralPerturbations.md) _from a JSON object._ |
