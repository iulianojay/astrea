...
Switches (indices 1–23, all default to 1): 0 = off, 1 = on, 2 = main effects off but cross terms on. [**Switch**](structastrea_1_1astro_1_1planets_1_1Switch.md) 9: set to 1 for daily Ap only, -1 to use full ap array.
