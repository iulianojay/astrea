...
| virtual std::unique\_ptr&lt; [**EquationsOfMotion**](classastrea_1_1astro_1_1EquationsOfMotion.md) &gt; | [**clone**](#function-clone) () override const<br>_Creates a clone of the current Two Body object._  |
...
_Creates a clone of the current Two Body object._ 
```C++
inline virtual std::unique_ptr< EquationsOfMotion > astrea::astro::TwoBody::clone () override const
```
...
std::unique\_ptr&lt;EquationsOfMotion&gt; A unique pointer to the cloned Two Body object. 
