...
|   | [**QuaternionPartial**](#function-quaternionpartial-22) (const UnitlessPerTime & sDot, const [**CartesianVector**](structastrea_1_1astro_1_1CartesianVector.md)&lt; UnitlessPerTime, in\_frame &gt; & uDot) <br>_Constructor for the_ [_**QuaternionPartial**_](classastrea_1_1astro_1_1QuaternionPartial.md) _class from a scalar and a_[_**CartesianVector**_](structastrea_1_1astro_1_1CartesianVector.md) _._ |
|  std::vector&lt; double &gt; | [**force\_to\_double\_vector**](#function-force_to_double_vector) () const<br>_Converts the quaternion derivative to a vector form for use in numerical integration._  |
|  const UnitlessPerTime & | [**get\_scalar\_part**](#function-get_scalar_part) () const<br>_Gets the scalar part of the quaternion._  |
|  const [**CartesianVector**](structastrea_1_1astro_1_1CartesianVector.md)&lt; UnitlessPerTime, in\_frame &gt; & | [**get\_vector\_part**](#function-get_vector_part) () const<br>_Gets the vector part of the quaternion as a_ [_**CartesianVector**_](structastrea_1_1astro_1_1CartesianVector.md) _._ |
|  [**Quaternion**](classastrea_1_1astro_1_1Quaternion.md)&lt; in\_frame, out\_frame &gt; | [**operator\***](#function-operator) (const Time & dt) const<br>_Multiplies the quaternion derivative by a time quantity to get a quaternion representing the change in attitude over that time interval._  |
...
```C++
inline std::vector< double > astrea::astro::QuaternionPartial::force_to_double_vector () const
```
