...
inline auto get_checkcase_database()
{
    return sqlite_orm::make_storage(
        ...
        sqlite_orm::make_table(
            ...
            sqlite_orm::make_column("bodyAngularVelocityWrtEi_deg_s_Roll", &AtmosphericCheckcaseRow::bodyAngularVelocityWrtEi_deg_s_Roll),
            sqlite_orm::make_column("bodyAngularVelocityWrtEi_deg_s_Pitch", &AtmosphericCheckcaseRow::bodyAngularVelocityWrtEi_deg_s_Pitch),
            sqlite_orm::make_column("bodyAngularVelocityWrtEi_deg_s_Yaw", &AtmosphericCheckcaseRow::bodyAngularVelocityWrtEi_deg_s_Yaw),
        ...
        sqlite_orm::make_table(
            ...
            sqlite_orm::make_column("bodyAngularVelocityWrtEi_rad_s_Roll", &OrbitalCheckcaseRow::bodyAngularVelocityWrtEi_rad_s_Roll),
            sqlite_orm::make_column("bodyAngularVelocityWrtEi_rad_s_Pitch", &OrbitalCheckcaseRow::bodyAngularVelocityWrtEi_rad_s_Pitch),
            sqlite_orm::make_column("bodyAngularVelocityWrtEi_rad_s_Yaw", &OrbitalCheckcaseRow::bodyAngularVelocityWrtEi_rad_s_Yaw),
...
#include <tests/nasa_6dof_checkcases/helpers/CheckcaseDatabase.ipp>