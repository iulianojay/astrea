/**
 * @file TurnThrustersOff.hpp
 * @author Jay Iuliano (iuliano.jay@gmail.com)
 * @brief A class representing a TurnThrustersOff Event in the astrea astro platform.
 * @date 2026-03-14
 *
 ...
 */
class TurnThrustersOff {

  public:
    /**
     * @brief Constructs a TurnThrustersOff Event that triggers at a specific altitude.
     *
     * @param triggerAltitude The altitude at which the TurnThrustersOff should trigger. Default is 0 km, which means it
     * will trigger when the vehicle reaches the default crash radius of the central body.
     * @return TurnThrustersOff A TurnThrustersOff Event that triggers at the specified altitude.
     */
    TurnThrustersOff();
