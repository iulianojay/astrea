...
{
    return { _x / astrea::detail::distance_unit,
             _y / astrea::detail::distance_unit,
             _z / astrea::detail::distance_unit,
             _vx / (astrea::detail::distance_unit / astrea::detail::time_unit),
             _vy / (astrea::detail::distance_unit / astrea::detail::time_unit),
             _vz / (astrea::detail::distance_unit / astrea::detail::time_unit) };
}
