...
class Oberon : public CelestialBody {
  ...
  public:
     ...
     *
     * Initializes the Oberon object with predefined physical and orbital parameters.
     */
    constexpr Oberon() :
        CelestialBody(
            "Oberon",                    //!< Name
    ...
    /**
     * @brief Default destructor for the Oberon class.
     */
    ~Oberon() = default;

    /**
     * @brief Get the unique identifier for the Oberon celestial body.
     *
     * @return CelestialBodyId The unique identifier for Oberon.
     */
