...
{
    const auto velocityMbFromSsb = get_velocity_at_impl<MercuryEphemerisTable, frames::solar_system_barycenter::icrf>(date);
    return velocityMbFromSsb; // TODO: Add correction for Mercury's velocity from Mercury barycenter
}
