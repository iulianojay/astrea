  ...
  public:
    constexpr Callisto() :
        CelestialBody(
            ...
            Angle(351.491 * mp_units::angular::unit_symbols::deg),              //!< Argument of perigee
            ...
            BodyAngularRate(1012394.6 * mp_units::angular::unit_symbols::deg / JulianCentury), //!< Rate of change of the argument of perigee
