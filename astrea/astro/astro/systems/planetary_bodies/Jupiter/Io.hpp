  ...
  public:
    constexpr Io() :
        CelestialBody(
            ...
            Angle(128.106 * mp_units::angular::unit_symbols::deg),              //!< Argument of perigee
            ...
            BodyAngularRate(97220153.4 * mp_units::angular::unit_symbols::deg / JulianCentury), //!< Rate of change of the argument of perigee
