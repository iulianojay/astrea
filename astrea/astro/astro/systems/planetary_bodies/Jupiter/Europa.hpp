...
class Europa : public CelestialBody {
  ...
  public:
     ...
     *
     * Initializes the Europa object with predefined physical and orbital parameters.
     */
    constexpr Europa() :
        CelestialBody(
            "Europa",                    //!< Name
            ...
            Angle(308.076 * mp_units::angular::unit_symbols::deg), //!< Longitude of perigee
    ...
    /**
     * @brief Default destructor for the Europa class.
     */
    ~Europa() = default;

    /**
     * @brief Get the unique identifier for the Europa celestial body.
     *
     * @return CelestialBodyId The unique identifier for Europa.
     */
