...
inline consteval CelestialBodyParameters get_celestial_body_parameters<moons::Rhea>()
{
    ...
    return { .type                   = CelestialBodyType::MOON,
             ...
             .equatorialRadius       = Distance(746.0 * km),
             ...
             .rightAscensionRate     = BodyAngularVelocity(37688.33 * deg / jc),
             .longitudeOfPerigeeRate = BodyAngularVelocity(11498.3 * deg / jc),
             .meanLongitudeRate      = BodyAngularVelocity(59680892.45 * deg / jc) };
}
