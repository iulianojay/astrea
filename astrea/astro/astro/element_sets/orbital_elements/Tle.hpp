...
class Tle {
  ...
  public:
    Tle(Unitless scale = 0.0 * astrea::detail::unitless) :
        _x(scale * astrea::detail::distance_unit),
        _y(scale * astrea::detail::distance_unit),
        _z(scale * astrea::detail::distance_unit),
        _vx(scale * astrea::detail::distance_unit / astrea::detail::time_unit),
        _vy(scale * astrea::detail::distance_unit / astrea::detail::time_unit),
        _vz(scale * astrea::detail::distance_unit / astrea::detail::time_unit)
    {
    }
