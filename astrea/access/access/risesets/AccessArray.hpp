 ...
 */
template <>
struct std::less<astrea::accesslib::IdPair> {
    /**
     ...
     */
    bool operator()(const astrea::accesslib::IdPair& lhs, const astrea::accesslib::IdPair& rhs) const
    {
